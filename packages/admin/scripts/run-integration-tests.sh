#!/usr/bin/env bash
# Run admin integration tests against ephemeral Postgres (local dev),
...
PACKAGE_DIR="${ROOT_DIR}/packages/admin"
...
COMPOSE_PROJECT="slugbase-admin-test-${RUN_ID}"
TEST_PG_VOLUME_NAME="slugbase-admin-test-pg-${RUN_ID}"

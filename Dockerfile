...
# Edition selector drives VITE_* presets at web build time (spec §15, #481)
ARG SLUGBASE_EDITION=ce
# Optional explicit VITE_* overrides (normally derived from SLUGBASE_EDITION)

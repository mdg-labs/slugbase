...
Open **Admin** in the app, then choose **Billing** (an extra tab on Cloud). The page loads an overview for the **current workspace** in your session and shows plan, subscription status, renewal or period end when applicable, seat usage, and plan limit summaries.
...
<Columns cols="2">
  ...
  <Card title="Workspaces" href="/cloud/workspaces" icon="building-2">
    Which workspace billing applies to.
  </Card>
</Columns>

...
<Callout kind="info">
  **Cloud vs self-hosted:** The hosted product at [slugbase.app](https://slugbase.app) adds workspaces, plans, and billing on top of the same core app. Features that work the same way in both editions are documented here; Cloud-only topics are in the [Cloud guides](/cloud/introduction).
</Callout>

...
function BookmarkCard({ b, selected, onSelect, onPin, onEdit }) {
  return (
    <div className={"card" + (selected ? " sel" : "") + (b.pinned ? " pinned" : "")}
      ...
      <div className="card-url">
        <Icon name="globe" size={12} style={{ opacity: .6, flex: "none" }} />
...
function BookmarkRow({ b, selected, onSelect, onPin, sort, onEdit }) {
  return (
